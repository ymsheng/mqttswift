#
#  Be sure to run `pod spec lint MqttSwift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "yangmaosheng" => "ymsheng@outlook.com" }
  # Or just: s.author    = "yangmaosheng"
  # s.authors            = { "yangmaosheng" => "ymsheng@outlook.com" }
  s.social_media_url   = "http://ymsheng.github.io/"
